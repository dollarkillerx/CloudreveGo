...
class LocalStorage {
  ...
  static setConf(ConfigData data) async {
    final jsonStr = jsonEncode(data.toJson());
    await _storage.setString(_cloudrevegoConf, jsonStr);
  }

  static ConfigData? getConf() {
    final jsonStr = _storage.getString(_cloudrevegoConf);
